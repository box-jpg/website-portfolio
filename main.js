...
function init() {
  ...
  // Texture loader with error handling and CORS support
  ...
  // Throttle scroll event to ~60fps (16ms)
  document.body.onscroll = throttle(moveCamera, 16);
  
  // Safely call moveCamera after ensuring DOM is ready
  try {
    moveCamera();
  } catch (e) {
    console.warn('Error in initial moveCamera:', e);
  }
